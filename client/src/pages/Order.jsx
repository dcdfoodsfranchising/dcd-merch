...
import { getUserOrders, cancelOrder, buyAgainOrder } from "../services/orderService";
import { useNavigate } from "react-router-dom";
import CancelConfirmModal from "../components/Order/ConfirmCancel"; // <-- import here
...
const Order = () => {
    ...
    >
      ...
      <div className="flex justify-end mt-4 gap-2">
        ...
        <button
          ...
          onClick={() => handleBuyAgain(item)} // item is the product from productsOrdered
        >
          Buy Again
        </button>
      </div>
  ...
  const handleBuyAgain = async (item, deliveryDetails) => {
    const payload = {
    ...
    try {
      const result = await buyAgainOrder(payload);
